...
void emitLightAlertOn(int poleToSendId) {
  mesh.sendSingle(poleToSendId, "TURN_ON");
}
...
void sendLigthAlertOnMessageToNextPole(int currentPoleId) {
  switch (currentPoleId)
  {
    case ID_GATEWAY:
      emitLightAlertOn(ID_POLE_1);
      break;
    case ID_POLE_1:
      emitLightAlertOn(ID_GATEWAY);
      emitLightAlertOn(ID_POLE_2);
      break;
    case ID_POLE_2:
      emitLightAlertOn(ID_POLE_1);
      break;
